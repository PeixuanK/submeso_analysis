...
legend([hh1,hh2,hh3,hh4],'Regime 1','Regime 2','Regime 3','Regime 4','FontSize',11,'FontWeight','bold','Position', [0.39, 0.28, 0.25, 0.06],'Orientation','horizontal');
...
text(0.03, 0.9, '(a) Original', 'Units', 'normalized', 'FontWeight', 'bold', 'FontSize', 13);
...
set(ax1,'XTick', [],'YTick', []); 
set(gca,'LineWidth',1.5);
text(0.03, 0.9, '(b) Original', 'Units', 'normalized', 'FontWeight', 'bold', 'FontSize', 13);
...
set(ax1,'XTick', [],'YTick', []);  
set(gca,'LineWidth',1.5);
text(0.03, 0.9, '(c) Turbulent', 'Units', 'normalized', 'FontWeight', 'bold', 'FontSize', 13);
...
set(ax1,'XTick', [],'YTick', []); 
set(gca,'LineWidth',1.5);
text(0.03, 0.9, '(d) Turbulent', 'Units', 'normalized', 'FontWeight', 'bold', 'FontSize', 13);
